...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .codepiperignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".codepiperignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .codepiperignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".codepiperignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.codepiperignore", "level3/"],
    ]);
    const result = await shouldIgnore(
