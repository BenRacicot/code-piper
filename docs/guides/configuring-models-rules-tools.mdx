...
For example, to use the [Claude 4 Sonnet model](https://continue.dev/anthropic/claude-4-sonnet), you'd reference it as `anthropic/claude-4-sonnet`.
...
- **[Continue Mission Control](https://continue.dev)**: Browse community models, rules, and tools
