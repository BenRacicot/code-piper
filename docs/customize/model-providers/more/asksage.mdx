...
<Tip>
  **Discover Ask Sage models [here](https://continue.dev/hub?q=Ask%20Sage)**
</Tip>
...
Add your Ask Sage model to your Continue configuration file, which is located at `~/.codepiper/config.yaml`. If it does not exist, create it.
