...
4. **Global rules** (from `~/.codepiper/rules` folder)
...
1. **Browse existing rules**: [Explore available rules](https://continue.dev/hub?type=rules)
2. **Create new rules**: [Create your own](https://continue.dev/new?type=block&blockType=rules) in the Hub
...
2. Go to [Create new rule](https://continue.dev/new?type=block&blockType=rules)
...
2. **For Hub rules**: Go directly to your assistant page on [Continue Mission Control](https://continue.dev) and edit from there
