...
const TelemetryProviders = ({ children }: PropsWithChildren) => {
  ...
  // TODO: Remove CodePiper team member check once Sentry is ready for all users
  ...
  // Conditionally wrap with ErrorBoundary when telemetry is enabled and user is CodePiper team member
  const content =
    allowAnonymousTelemetry && hasContinueEmail ? (
