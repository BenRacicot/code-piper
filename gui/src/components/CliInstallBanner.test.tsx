...
describe("CliInstallBanner", () => {
  ...
  describe("CLI detection", () => {
    it("does not render when CLI is installed (subprocess returns path)", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText("Try out the CodePiper CLI"),
    ...
    it("renders when CLI is not installed (subprocess returns empty)", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Try out the CodePiper CLI"),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Banner content", () => {
    ...
    it("displays the title", () => {
      expect(screen.getByText("Try out the CodePiper CLI")).toBeInTheDocument();
    });
    ...
    it("displays the CommandLine icon", () => {
      ...
      const banner = screen
        .getByText("Try out the CodePiper CLI")
        .closest("div");
