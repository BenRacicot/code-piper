...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "codepiper.diffVisible", true);
  ...
  async streamEdit({
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("codepiper.rejectDiff");
      }
