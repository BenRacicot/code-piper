...
tasks {
    ...
    test {
        useJUnitPlatform()
        environment("CODEPIPER_GLOBAL_DIR", "${rootProject.projectDir}/src/test/kotlin/com/github/continuedev/continueintellijextension/test-continue")
...
val testIntegration = task<Test>("testIntegration") {
    ...
    environment("CODEPIPER_GLOBAL_DIR", "${rootProject.projectDir}/src/testIntegration/kotlin/com/github/continuedev/continueintellijextension/test-continue")
    useJUnitPlatform()
